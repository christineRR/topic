	...
	var Tab = React.createClass({ displayName: "Tab",
	    ...
	    render: function () {
	        ...
	        var tabNavNodes = this.props.tabs.map(function (item, i) {
	            return React.createElement("li", { key: i, style: { width: 1 / this.props.tabs.length * 100 + "%" }, onClick: this.clickHandler.bind(this, item), className: this.state.active == item ? 'active' : '' }, item);
	        }, this);
	        return React.createElement("div", null, React.createElement("ul", { className: "tabWrap" }, tabNavNodes), React.createElement("div", { className: "tabContent" }, this.state.showItem));
	    }
	});

	ReactDOM.render(React.createElement(Tab, { url: "./data", showItem: "tab1", tabs: ['tab1', 'tab2', 'tab3'] }), document.getElementById("container"));
